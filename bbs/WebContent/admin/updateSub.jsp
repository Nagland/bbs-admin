...
<body>
	...
	<input id="forumId" value="<s:property value='singleSubforum.forum.id'/>" style="display:none">
	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<form class="form-horizontal" action="<%=basePath%>/admin/sub!update.action" method="post">  
          	<input name="id" value="<s:property value='singleSubforum.id'/>" style="display:none">
            <fieldset>  
                <legend>修改子栏目</legend>  
                ...
                <div class="control-group">
            		...
            		<div class="controls docs-input-sizes fr">
             		     ...
             		     <input class="span6" id="name"  name="name"
								type="text" value="<s:property value='singleSubforum.name'/>">
              ...
              <div class="control-group">
            		...
            		<div class="controls docs-input-sizes fr">
             		     ...
             		     <input class="span6" id="moderato"  name="moderato"
								type="text" placeholder="" value="<s:property value='singleSubforum.user.userName'/>">
              	 ...
              	 <div class="control-group">
            		...
            		<div class="controls docs-input-sizes fr">
             		     ...
             		     <textarea class="span6" id="description" name="description" 
								type="text" rows="9">value="<s:property value='singleSubforum.description'/>"</textarea>
              	 ...
              	 <div class="control-group">
            		...
            		<div class="controls docs-input-sizes fr">
             		     ...
             		     <input class="span6" id="replyLevel"  name="replyLevel"
								type="text" placeholder="必须为数字" value="<s:property value='singleSubforum.replyLevel'/>">
              	 ...
              	 <div class="control-group">
            		...
            		<div class="controls docs-input-sizes fr">
             		     ...
             		     <input class="span6" id="postLevel"  name="postLevel"
								type="text" placeholder="必须为数字" value="<s:property value='singleSubforum.postLevel'/>">
              	 ...
              	 <div class="control-group">
            		...
            		<div class="controls docs-input-sizes fr">
             		     ...
             		     <input class="span6" id="scanLevele"  name="scanLevel"
								type="text" placeholder="必须为数字" value="<s:property value='singleSubforum.scanLevel'/>">
