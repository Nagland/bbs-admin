     ...
     <div class="container-fluid">
      <div class="row-fluid">
       <jsp:include page="/admin/userSidebar.jsp"></jsp:include>
        ...
        <div class="span9">
           <form class="form-horizontal" action="<%=basePath%>/admin/user!update.action" method="post">
            ...
            <fieldset>  
                ...
                <div class="control-group">
            		...
            		<div class="controls docs-input-sizes fr">
             		     ...
             		     <input class="span6" id="userName"  name="userName"
								type="text" value="<s:property value="singleUser.userName" />">   
     			    </div>
              ...
              <div class="control-group">
            		...
            		<div class="controls docs-input-sizes fr">
             		     ...
             		     <input class="span6" id="email" name="email" 
								type="text" value="<s:property value="singleUser.email" />">
              ...
              <div class="control-group">
            		...
            		<div class="controls docs-input-sizes fr">
             		     ...
             		     <input class="span6" id="score" name="score" 
								type="text" value="<s:property value="singleUser.score" />">
